...
const serviceDetails = {
  ...
  removal: { title: "Safe Tree Removal & Felling", desc: "When a tree becomes dangerous, diseased, or unwanted, professional removal is the best path. We employ top rigging safety systems to fell trees with minimal landscape impact.", img: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_avif,q_35,w_600/service_removal_gezia2", imgWebp: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_avif,q_35,w_600/service_removal_gezia2", imgAvif: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_avif,q_35,w_600/service_removal_gezia2", points: ["Hazardous and leaning tree removal","Storm-damaged structure extraction","Crane-assisted complex tree felling","Full safety buffer zone management"] },
