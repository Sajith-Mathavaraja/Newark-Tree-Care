...
export default function App() {
  ...
  const serviceDetails = {
    assessment: {
      ...
      icon: "assessment",
      img: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_assessment_jh70qw",
      imgWebp: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_assessment_jh70qw",
      imgAvif: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_assessment_jh70qw",
      points: [
    ...
    removal: {
      ...
      icon: "removal",
      img: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_removal_gezia2",
      imgWebp: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_removal_gezia2",
      imgAvif: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_removal_gezia2",
      points: [
    ...
    stump: {
      ...
      icon: "stump",
      img: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_stump_tzemwh",
      imgWebp: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_stump_tzemwh",
      imgAvif: "https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/service_stump_tzemwh",
      points: [
          ...
          <div className="hero-content-box">
           ...
           <div className="hero-composition-wrapper">
            <div className="hero-main-frame">
              <img src="https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_800/hero_arborist_q6wspn" alt="Professional Arborist at work in Newark" width="800" height="446" fetchpriority="high" />
            </div>
            ...
            <div className="overview-editor-grid">
              <div className="overview-asymmetric-photo">
                ...
                <div className="photo-front-frame">
                  <img src="https://res.cloudinary.com/qzlxlo1n/image/upload/f_auto,q_auto:eco,w_600/tree_services_zu0ne8" alt="Our arborist crew operating tree chipping equipment safely" width="600" height="448" />
                </div>
              </div>
